...
namespace QuanLySinhVien
{
    public partial class AdminControl : Form
    {
        ...
        public void load()
        {
            dataGridView1.DataSource = Connect.LayBang("select tk,convert(varchar(32),hashbytes('md5',mk),2) from TkAdmin");
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    String sql = "insert into TkAdmin values('" + textBox1.Text + "','" + getMD5(textBox2.Text.Trim()) + "')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                String sql = "update TkAdmin set mk='" + getMD5(textBox2.Text.Trim()) + "' where tk = '"+textBox1.Text+"'";
                Connect.ThemXuaXoa(sql);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (rs == DialogResult.OK)
            {
                try
                {
                    String sql = "delete from TkAdmin where tk = '"+textBox1.Text+"'";
                    Connect.ThemXuaXoa(sql);
                    textBox1.Text = "";
                    textBox2.Text = "";
                    load();

...
namespace QuanLySinhVien
{
    public partial class UserControl : Form
    {
        ...
        public void load()
        {
            dataGridView1.DataSource = Connect.LayBang("select tk,convert(varchar(32),hashbytes('md5',mk),2) from TkUser");
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    String sql = "insert into TkUser values('" + textBox1.Text + "','" + getMD5(textBox2.Text.Trim()) + "')";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                String sql = "update TkUser set mk='" + getMD5(textBox2.Text.Trim()) + "' where tk = '" + textBox1.Text + "'";
                Connect.ThemXuaXoa(sql);
